...
def main():
    ...
    if pay < 0:
        print(f'Продавец должен возместить разницу\n'
              f'компании.')
...
def get_sales():
    ...
    mountly_sales = float(input('Введите сумму месячных продаж: '))

    # Вернуть введенную сумму
    return mountly_sales

# Функция get_advanced_pay получает сумму
# авансовой выплаты конкрутному продавцу 
# и возвращает эту сумму.
def get_advanced_pay():
    # Получить сумму авансовой выплаты.
    print(f'Введите сумму авансовой выплаты либо\n'
          f'введите 0, если такой выплаты не было.')
